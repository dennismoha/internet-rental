...
userRoute.post('/user/login',(req,res,next)=> {	
	passport.authenticate('local',{
		...
		successRedirect : '/page/users/property_page',
...
userRoute.get('/users/getUser/:id',checkRole.allowIfLoggedin,Usersign.getUser) //getting a single user
userRoute.delete('/users/removeUser',Usersign.deleteUser) //removing a single user
userRoute.put('/users/updateUser',Usersign.updateUser)
